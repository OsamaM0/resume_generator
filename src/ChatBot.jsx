...
5. After gathering sufficient information (usually 4-8 exchanges), include the EXACT token [READY_TO_GENERATE] at the END of your message
...
READINESS SIGNAL:
When you believe you have enough information for an excellent resume, deliver an encouraging summary of what you've gathered (key strengths, target role alignment, standout achievements) and include [READY_TO_GENERATE] at the very end of your message. Don't rush — quality of gathered information matters.
...
export default function ChatBot({
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      const fn = provider.id === "anthropic" ? chatAnthropic : chatOpenAI;
      const response = await fn(provider, CHAT_SYSTEM_PROMPT, apiMessages, pdfBase64);
      ...
      {(isReady || showManualReady) && (
        <div style={{ padding: "0.5rem 0" }}>
          <button
            ...
            style={{
              width: "100%",
              background: isReady ? "#c9991a" : "#1a1508",
              color: isReady ? "#000" : "#c9991a",
              border: isReady ? "none" : "1px solid #c9991a",
              borderRadius: 3,
              padding: "0.9rem",
              fontSize: 14,
              fontWeight: 700,
